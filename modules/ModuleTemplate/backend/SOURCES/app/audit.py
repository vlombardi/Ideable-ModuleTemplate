...
def make_synthetic_creation_row(
    ...
    **field_overrides: Any,
    ...
    base = {
        ...
        "au_creation_timestamp": ts,
        "au_last_update_timestamp": ts,
...
def version_row_to_schema(
    ...
    **extra_fields: Any,
    ...
    data = {
        ...
        "au_creation_timestamp": ts,
        "au_last_update_timestamp": ts,
        "au_created_by_user": actor,
        "au_last_updated_by_user": actor,
    }
...
def merge_and_sort_history(
    ...
    merged.sort(
        key=lambda r: (r.au_creation_timestamp or fallback, r.transaction_id),
        reverse=True,
    )
    return merged
