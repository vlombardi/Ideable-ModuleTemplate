...
- `remoteEntry` must point to the remote container JS bundle (`remoteEntry.js`). When omitted, HostApp falls back to `entry` for backwards compatibility, but remotes should define it explicitly.
