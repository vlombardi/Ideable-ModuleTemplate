      ...
      <div className="template-w-full template-max-w-md template-rounded-lg template-bg-background template-p-6 template-shadow-lg template-space-y-4">
        ...
        <div className="template-flex template-flex-wrap template-justify-end template-gap-2">
          <button
            ...
            className="template-inline-flex template-items-center template-justify-center template-rounded-md template-border template-border-input template-bg-background template-px-4 template-py-2 template-text-sm template-font-medium template-shadow-sm template-transition-colors hover:template-bg-accent hover:template-text-accent-foreground"
          >
            {keepEditingLabel}
          </button>
          <button
          ...
          {onSave && saveLabel ? (
            <button
              ...
              className="template-inline-flex template-items-center template-justify-center template-rounded-md template-bg-primary template-px-4 template-py-2 template-text-sm template-font-medium template-text-primary-foreground template-shadow-sm template-transition-colors hover:template-bg-primary/90"
            >
              {saveLabel}
            </button>
          ) : null}
