/**
 * Environment configuration for ModuleTemplate frontend
...
export const oidcConfig = {
  authority: getEnv('VITE_OIDC_AUTHORITY', 'https://casa-cataplano.duckdns.org/application/o/ideable/'),
  client_id: getEnv('VITE_OIDC_CLIENT_ID', 'ideable-client'),
  redirect_uri: getEnv('VITE_OIDC_REDIRECT_URI', 'https://casa-cataplano.duckdns.org/auth/callback'),
  post_logout_redirect_uri: getEnv('VITE_OIDC_POST_LOGOUT_REDIRECT_URI', 'https://casa-cataplano.duckdns.org'),
  response_type: 'code',
