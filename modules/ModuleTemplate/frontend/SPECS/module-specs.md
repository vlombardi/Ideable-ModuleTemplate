...
- Remote modules must rely on HostApp-managed authentication and session renewal; they must not introduce their own OIDC login or silent-renew recovery flow.
