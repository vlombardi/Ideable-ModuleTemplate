...
- **Modal Field Requirements**: Create and edit modals must include ALL available entity fields (excluding auto-generated audit data):
  - All foreign key fields should be dropdown selectors with "None" option for nullable fields
  ...
  - Example: Digital Shelters modals must include enabled, project_fk, scope_fk fields in addition to name and description
...
When in edit mode, the associated entity should be displayed as a dropdown menu.
