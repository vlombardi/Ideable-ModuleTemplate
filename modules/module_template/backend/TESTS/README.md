...
4. Keep JWKS validation and host_app permission-context integration.
...
This directory contains integration tests for the module_template backend API.
...
# Run tests
cd modules/module_template/backend
pytest TESTS/ -v
```
