...
def test_auth_supports_permission_payload_variants() -> None:
    ...
    # Permissions are flattened from per-module claim arrays (e.g. 'template.permissions')
    # and generic 'permissions' arrays, with the module prefix prepended, by
    # _get_permissions_from_claims.
    assert "_get_permissions_from_claims" in content
