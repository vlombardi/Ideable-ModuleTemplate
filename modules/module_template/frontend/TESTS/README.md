...
- `test_entity_table_contract.py` - source-level contract checks for table controls and query behavior
...
From repository root — the contract tests and the Playwright snapshots both run here:
