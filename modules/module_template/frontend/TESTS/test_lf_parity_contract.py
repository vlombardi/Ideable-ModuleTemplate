...
def test_serverdatatable_lf_class_parity_contract() -> None:
    slug = _get_slug()
    hostapp_table = PROJECT_ROOT / "modules" / "host_app" / "frontend" / "SOURCES" / "src" / "components" / "ServerDataTable.tsx"
    ...
    for fragment in table_class_fragments:
        assert fragment in host_compact, f"host_app ServerDataTable missing: {fragment}"
...
def test_entity_pages_lf_contract() -> None:
    ...
    hostapp_page = PROJECT_ROOT / "modules" / "host_app" / "frontend" / "SOURCES" / "src" / "pages" / "Users.tsx"
    ...
    for page_path in page_files:
        ...
        for fragment in page_class_fragments:
            assert fragment in host_compact, f"host_app Users.tsx missing: {fragment}"
