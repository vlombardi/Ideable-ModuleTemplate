...
try:
    ...
    HOSTAPP_ROOT = SOURCES_DIR
try:
    REPO_ROOT = HOSTAPP_ROOT.parents[1]
except IndexError:
    REPO_ROOT = HOSTAPP_ROOT
DEFAULT_BLUEPRINT_PATH = REPO_ROOT / "deployment_root" / "modules" / "HostApp" / "authentik" / "blueprints" / "authz-plan.generated.yaml"
