...
6. Regenerates the merged `deployment_root/.env` and `deployment_root/docker-compose.yml` by executing `deployment_root/scripts/create-merged-configuration.sh`
...
├── scripts/
│   └── create-merged-configuration.sh  ← regenerates merged .env and docker-compose.yml
└── modules/
    ├── HostApp/
    │   ├── config/
