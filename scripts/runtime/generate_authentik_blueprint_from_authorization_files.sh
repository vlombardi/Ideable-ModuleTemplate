...
echo "[blueprint] Done."
echo "  Blueprint: ${DEPLOYMENT_ROOT}/modules/host_app/authentik/blueprints/authz-plan.generated.yaml"
echo "  Log:       ${DEPLOYMENT_ROOT}/modules/host_app/authentik/blueprints/blueprint_generation.log"
