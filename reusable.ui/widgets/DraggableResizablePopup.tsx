...
export default function DraggableResizablePopup({
  ...
  return createPortal(
    ...
    >
      <div
        className={cn(
          "ideable:absolute ideable:bg-white ideable:rounded-lg ideable:border ideable:shadow-lg ideable:flex ideable:flex-col ideable:overflow-hidden",
        )}
        style={{
          left: position.x,
          top: position.y,
      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={onClose}
            className="ideable:inline-flex ideable:h-8 ideable:w-8 ideable:items-center ideable:justify-center ideable:rounded-md ideable:border hover:ideable:bg-accent"
          >
