...
def pytest_configure(config):
    ...
    if os.environ.get(_ALLOW) == "1":
        print(
            ...
            "   Official / gate run:  ./scripts/dev/common/run_enabled_tests.sh\n",
            file=sys.stderr,
        )
        return
...
# helpers — which is precisely the duplication `scripts/dev/common/container_stack_env.sh` says this
